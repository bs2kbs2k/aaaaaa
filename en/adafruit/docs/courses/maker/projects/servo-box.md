...
| Hours | |-| | ![3 hours on a 4 hour time scale](/static/courses/maker/projects/common/3-0-hours.png) |   
...
* Yellow / orange goes to **A1** or **A2** Pins. For more details on connecting servo motors, see the section on Servo Motors in [Coding the Circuit Playground Express](/courses/maker/general/coding) chapter.
