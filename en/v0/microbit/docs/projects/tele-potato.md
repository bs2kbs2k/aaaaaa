...
Receiving the potato is done in the [`||radio:on radio received||`](/reference/radio/on-data-packet-received) block. The **receivedNumber** represents the potato and is stored in the **potato** variable.
