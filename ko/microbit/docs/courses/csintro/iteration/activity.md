...
![게임 스프라이트 블록](/static/courses/csintro/iteration/game-sprite.png)
...
![게임 스프라이트 블록 매개 변수](/static/courses/csintro/iteration/sprite-params.png)
...
The ‘for’ block is useful when you have a variable in your loop that you want to change by a fixed amount within a specific range each time through a loop. What does this mean? 예시를 살펴보겠습니다.
