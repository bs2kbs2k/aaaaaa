...
시뮬레이터에서 LED 밝기 렌더링이 더 많이 향상되었습니다. Additionally, a new api [plot brightness](https://makecode.microbit.org/reference/led/plot-brightness) was added to control the brightness of LEDs individually.
